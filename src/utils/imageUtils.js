 ...
 */
export function createFigmaImageWithMemoryManagement(imageBytes, imageId, memoryManager) {
 ...
 */
export function resizeImageBytes(imageBytes, filename) {
    return __awaiter(this, void 0, void 0, function* () {
 ...
 */
export function processFigmaImage(imageData) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (imageData.imageBytes.length > UI_CONSTANTS.MAX_IMAGE_SIZE) {
                ...
                // Resize the image
                const resizedBytes = yield resizeImageBytes(imageData.imageBytes, imageData.filename);
                // Return resized image data
                return Object.assign(Object.assign({}, imageData), { imageBytes: resizedBytes, filename: imageData.filename + " (resized)" });
            }
 ...
 * @returns URL string
 */
export function getSearchUrl(query, engine) {
