 ...
 */
export function createTextNode(text_1) {
    return __awaiter(this, arguments, void 0, function* (text, options = {}) {
        try {
            ...
            if (options.x !== undefined)
                textNode.x = options.x;
            if (options.y !== undefined)
                textNode.y = options.y;
            // Set size if specified
            if (options.width !== undefined || options.height !== undefined) {
                textNode.resize(options.width !== undefined ? options.width : textNode.width, options.height !== undefined ? options.height : textNode.height);
            }
...
export function createFrame(options = {}) {
    try {
        ...
        // Set size if specified
        if (options.width !== undefined || options.height !== undefined) {
            frame.resize(options.width !== undefined ? options.width : frame.width, options.height !== undefined ? options.height : frame.height);
        }
        // Set position if specified
        if (options.x !== undefined)
            frame.x = options.x;
